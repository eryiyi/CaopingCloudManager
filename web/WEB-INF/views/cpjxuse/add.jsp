    ...
    <div class="col-xs-12 col-sm-12">
        <div class="box">
            ...
            <div class="box-content">
                <h4 class="page-header">添加机械用途</h4>
                ...
                <form class="form-horizontal" role="form">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-4">
                            <input type="text" id="cloud_caoping_use_cont"  class="form-control" placeholder="用途描述"
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-4">
                            <input type="text" id="cloud_caoping_use_num" value="0" class="form-control" placeholder="排序 数字"
                                   data-toggle="tooltip" data-placement="bottom" title="Tooltip for name">
                        </div>
                    </div>
...
<script type="text/javascript">
    function saveP() {
        ...
        $.ajax({
            cache: true,
            type: "POST",
            url: "/cpJixieUseController/add.do",
            data: {
                "cloud_jixie_use_cont": cloud_caoping_use_cont,
                "cloud_jixie_use_pic": imagePath,
                "cloud_jixie_use_num": cloud_caoping_use_num
            },
            async: false,
