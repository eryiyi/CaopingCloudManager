    ...
    <div class="col-xs-12 col-sm-12">
        <div class="box">
            ...
            <div class="box-content">
                <h4 class="page-header">添加草种规格</h4>
                ...
                <form class="form-horizontal" role="form">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-4">
                            <input type="text" id="cloud_jixie_guige_cont"  class="form-control" placeholder="规格描述"
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-4">
                            <input type="text" id="cloud_jixie_guige_num" value="0" class="form-control" placeholder="排序 数字"
                                   data-toggle="tooltip" data-placement="bottom" title="Tooltip for name">
                        </div>
                    </div>
...
<script type="text/javascript">
    function saveP() {
        ...
        $.ajax({
            cache: true,
            type: "POST",
            url: "/cpCaozhongGuigeController/add.do",
            data: {
                "cloud_caozhong_guige_cont": cloud_jixie_guige_cont,
                "cloud_caozhong_guige_num": cloud_jixie_guige_num
            },
            async: false,
