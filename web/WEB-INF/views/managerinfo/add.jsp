            ...
            <div class="box-content">
                ...
                <form class="form-horizontal" role="form">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-4">
                            <input type="text" id="lat_company" class="form-control" value="${info.lat_company}" readonly="true"
                                   data-toggle="tooltip" data-placement="bottom" title="Tooltip for name">
                            <input type="text" id="lng_company" class="form-control" value="${info.lng_company}" readonly="true"
                                   data-toggle="tooltip" data-placement="bottom" title="Tooltip for name">
                        </div>
                    </div>
