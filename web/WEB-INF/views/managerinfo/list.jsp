...
<script type="text/javascript">
    ...
    function searchIndex(e) {
        ...
        if (_index <= ${page.pageCount} && _index >= 1) {
            window.location.href = "#module=managerinfo/list&page=" + _index + "&size=" + size+ "&_t="+ new Date().getTime();
        } else {
    ...
    function nextPage(_page) {
        ...
        if ((page <= ${page.pageCount} && page >= 1) || schoolId != '') {
            window.location.href = "#module=managerinfo/list&page=" + page + "&size=" + size+ "&_t="+ new Date().getTime();
        } else {
            alert("请输入1-${page.pageCount}的页码数");
        }
    }
