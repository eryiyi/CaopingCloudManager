    ...
    <div class="col-xs-12 col-sm-12">
        <div class="box ui-draggable ui-droppable">
            ...
            <div class="box-content">
                <input type="hidden" id="emp_id" name="emp_id" value="${query.emp_id}">
                <table class="table">
                    <thead>
                    <tr>
                        <th>#</th>
...
<script type="text/javascript">
    function searchIndex(e) {
        ...
        if (_index <= ${page.pageCount} && _index >= 1) {
            window.location.href = "#module=/countRecordController/list&page=" + _index + "&size=" + size + "&_t="+ new Date().getTime()+"&emp_id="+emp_id;
        } else {
    ...
    function nextPage(_page) {
        ...
        if ((page <= ${page.pageCount} && page >= 1) ) {
            window.location.href = "#module=/countRecordController/list&page=" + page + "&size=" + size + "&_t="+ new Date().getTime()+"&emp_id="+emp_id;
        } else {
            alert("请输入1-${page.pageCount}的页码数");
        }
    }
