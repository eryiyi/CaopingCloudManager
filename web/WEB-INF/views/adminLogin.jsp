...
<div class="login">
    <div class="above">
        <img src="/img/logo.png" alt="草坪云后台登陆"/>
    </div>
    <div class="bottom">
        <div class="line">
...
<script type="text/javascript">
    function login() {
        ...
        $.ajax({
            ...
            success: function (_data) {
                ...
                if (data.success) {
                    addCookie("loginName_cpy", username, 36);
                    addCookie("loginPassword_cpy", password, 36);
    ...
    function loginAuto() {
        var username = getCookie("loginName_cpy");
        var password = getCookie("loginPassword_cpy");
