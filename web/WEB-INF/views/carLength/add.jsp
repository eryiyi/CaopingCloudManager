            ...
            <div class="box-content">
                ...
                <form class="form-horizontal" role="form">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-4">
                            <input type="text" id="car_length_name"  class="form-control" placeholder="车长"
...
<script type="text/javascript">
    function saveP() {
        var car_length_name = $("#car_length_name").val();
        var car_num = $("#car_num").val();
        if (car_length_name.replace(/\s/g, '') == '') {
            alert("车型不能为空");
            return;
        }
        ...
        $.ajax({
            cache: true,
            type: "POST",
            url: "/carLengthController/add.do",
            data: {
                "car_length_name": car_length_name,
                "is_use": "0",
                "car_num": car_num
            },
            async: false,
