    ...
    <div class="col-xs-12 col-sm-12">
        <div class="box">
            ...
            <div class="box-content">
                <h4 class="page-header">编辑车型</h4>

                <form class="form-horizontal" role="form">
                    <input type="hidden" id="car_type_id" name="car_type_id" value="${cptype.car_type_id}">
                    <div class="form-group">
                        <label class="col-sm-2 control-label">车型</label>

                        <div class="col-sm-4">
                            <input type="text" id="car_type_name" value="${cptype.car_type_name}" class="form-control" placeholder="车型"
