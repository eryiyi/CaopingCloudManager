            ...
            <div class="box-content">
                ...
                <table class="table">
                    ...
                    <c:forEach items="${list}" var="e" varStatus="st">
                        <tr>
                            <td>${e.car_type_name}</td>
                            <td>
                                <a class="btn btn-default btn-sm" href="javascript:void (0)"
                                   onclick="editRole('${e.car_type_id}')" role="button">编辑</a>
                            </td>
                        </tr>
                    </c:forEach>
                    </tbody>
...
<script type="text/javascript">
    function editRole(_id) {
        if (confirm("确定要编辑么？")) {
            window.location.href = "#module=carTypeController/toEdit&car_type_id="+_id + "&_t=" + new Date().getTime();
        }
    }

    function addAd() {
        window.location.href = "#module=carTypeController/toAdd" + "&_t=" + new Date().getTime();
    }
    function searchOrder() {
        var is_use = $("#is_use").val();
        window.location.href = "#module=carTypeController/list&is_use=" + is_use + "&_t=" + new Date().getTime();
    }
</script>
