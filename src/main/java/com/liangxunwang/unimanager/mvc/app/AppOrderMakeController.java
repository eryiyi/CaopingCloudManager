...
public class AppOrderMakeController extends ControllerConstants {
    ...
    public String orderSave(String list){
        ...
        try {
            ...
            if (e.getMessage().equals("outOfNum")){
                return toJSONString(new ErrorTip(1, "支付宝生成订单失败，商品数量不够！"));
            }
     ...
     * @return
     */
    @RequestMapping(value = "/orderSaveSingle", produces = "text/plain;charset=UTF-8")
    @ResponseBody
    public String orderSaveSingle(String order_no, String doublePrices){
        ...
        try {
            ...
            if (e.getMessage().equals("ISWRONG")){
                return toJSONString(new ErrorTip(1, "支付失败，请稍后重试！"));
            }
        }
        return null;
    }
     ...
     * @return
     */
    @RequestMapping(value = "/orderSaveSingleWx", produces = "text/plain;charset=UTF-8")
    @ResponseBody
    public String orderSaveSingleWx(String order_no, String doublePrices){
        ...
        try {
            ...
            if (e.getMessage().equals("outOfNum")){
                return toJSONString(new ErrorTip(1, "微信支付失败，商品数量不够！"));
            }
        }
        return null;
    }
     ...
     * @return
     */
    @RequestMapping(value = "/orderSaveLq", produces = "text/plain;charset=UTF-8")
    @ResponseBody
    public String orderSaveLq(String list){
        ...
        try {
            ...
            if (e.getMessage().equals("ISWRONG")){
                return toJSONString(new ErrorTip(1, "零钱支付失败，请稍后重试！"));
            }
            else
            if (e.getMessage().equals("money_is_null")){
                return toJSONString(new ErrorTip(1, "零钱支付失败，余额不足！"));//
            }
        }
        return null;
    }
     ...
     * @return
     */
    @RequestMapping(value = "/orderSaveSingleLq", produces = "text/plain;charset=UTF-8")
    @ResponseBody
    public String orderSaveSingleLq(String order_no, String doublePrices){
        ...
        try {
            ...
            if (e.getMessage().equals("money_is_null")){
                return toJSONString(new ErrorTip(1, "零钱支付失败，余额不足！"));//零钱不够支付
            }
        }
        return null;
    }
...
//    private ExecuteService dxkChongzhiReturnCountService;
     ...
     * @return
     */
    @RequestMapping(value = "/orderUpdateSingle", produces = "text/plain;charset=UTF-8")
    @ResponseBody
    public String orderUpdateSingle(String order_no){
        appOrderUpdateService.update(order_no);

        OrdersVO order = (OrdersVO) appOrderFindService.findById(order_no);
...
//                    return toJSONString(new ErrorTip(1, "零钱支付失败，金额为空或0！"));
//                }
...
//        }
     ...
     * */
    @RequestMapping(value = "/selectOrderNum", produces = "text/plain;charset=UTF-8")
    @ResponseBody
    ...
    // 卖家扫一扫订单
    @RequestMapping(value = "/scanOrder", produces = "text/plain;charset=UTF-8")
     ...
     * @return
     */
    @RequestMapping(value = "/orderUpdateComment", produces = "text/plain;charset=UTF-8")
    @ResponseBody
